...
https://github.com/nionio6915/Euclid_Probe/blob/main/stls/Voron/Trident_TopMountDockCloseV4.stl
Once it's installed and you begin testing and finding the correct dock location, you may need to adjust the dock up/down.

## Config
I started off with the default Euclid Klipper config and combined with the Klicky config, but I found it suboptimal and somewhat hard to understand.  I customized it, and added comments to make it easier for you to understand what you'll need to change.
